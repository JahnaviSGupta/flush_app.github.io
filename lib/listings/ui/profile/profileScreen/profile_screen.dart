...
// final GlobalKey<SignUpScreen> signUpScreenKey = GlobalKey<SignUpScreen>();

class ProfileScreen extends StatefulWidget {
  final ListingsUser currentUser;

  const ProfileScreen({Key? key, required this.currentUser}) : super(key: key);
  // String favbathroom = SignUpScreen.SignUpState.favoriteBathroom;
  @override
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  // String bathroom = SignUpScreen.favoriteBathroom;
  @override
  void initState() {
    super.initState();
