...
import 'dart:math';
import 'hintTexts.dart' as hintFile;

// Selecting random hint texts form external file named hintTexts.dart
// In the main.dart file I imported the hintText file which contains the 
// different hint texts. I then used the random function to select 
// random strings from the list of hint strings and stored it in a 
// variable called theHitText
